      ...
      <span>
        ...
        <ul className="ContactStyle">
          ...
          <p className="BookingParagraphtyle">
            For any enquiries regarding Bookings, Commercial Partnerships,
            Publicity, Marketing & Social Media or to be in touch with MILO
            BEMBE’s Management, please use the relevant contact information.
          </p>
          <li>E-mail: milobembe@gmail.com</li>
          <li>Manager: Victor Hernandez - hola@victorhdez.es </li>
          <li>Cellphone + (35) 622-942-639</li>
          <a href="mailto:milobembe@gmail.com">
            Any question? Please keep me posted
          </a>
        </ul>
        ...
        <a href={slide2} download>
          <img
            src={slide2}
            alt="dj picture white-light"
            className="DjPictureStyle"
          />
        </a>
        <a href={slide3} download>
          <img
            src={slide3}
            alt="Dj picture at ocean Drive Barcelona"
            className="DjPictureStyle"
          />
        </a>
