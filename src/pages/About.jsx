  ...
  return (
    <div className="AboutStyle">
      <p className="AboutParagrahpStyle">
        {" "}
        <li>
          Milo Bembe, (Santa Marta-Colombia, December 11, 1982), is a Colombian
          DJ lover of House, Afro House and Tech House genres. He started at the
          age of 20 in clubs in Santa Marta mixing Caribbean & Latin local
        ...
        <li>
          ...
          Sitges, Sweat Bar Barceolna and many more. At festivals like Taste of
          Techno, and Sona que trona! If you want to hire him, you just have to
          contact us.
        </li>
      </p>
      <img
